...
export const ar = {
  ...
  // Home Page
heroTitle: 'من أرضك إلى مشروعك جاهز للسكن',
heroSubtitle: 'ننـفذ مشروعك من البداية حتى التسليم النهائي، بدايةً من البناء وحتى التشطيب المتكامل حسب احتياجاتك',
heroServiceOne: 'البناء',
...
aboutDescription2: 'نقدم حلول متكاملة تشمل التخطيط، التنفيذ، والتشطيب، مع الالتزام بأعلى معايير الجودة والدقة، وضمان التسليم في الوقت المتفق عليه. نرافقك خطوة بخطوة حتى اكتمال مشروعك.',
  ...
  // Team
  ourTeam: 'فريقنا',
  ourTeamSubtitle: 'تعرّف على المحترفين الموهوبين الذين يقفون خلف نجاحنا',

  // Contact
  getInTouch: 'تواصل معنا',
  contactSubtitle: 'هل أنت مستعد لتأسيس مشروعك؟ تواصل معنا اليوم لاستشارة متخصصة',
  ...
  projectNotFoundDesc: 'المشروع الذي تبحث عنه غير موجود',
  backToProjects: 'العودة إلى المشاريع',
  projectOverview: 'نظرة عامة على المشروع',
  projectDetails: 'تفاصيل المشروع',
  projectName: 'اسم المشروع',
  category: 'التصنيف',
  yearCompleted: 'سنة الإنجاز',
  requestInformation: 'طلب معلومات',
  projectGallery: 'معرض المشروع',
  projectHighlights: 'النقاط المميزة للمشروع',
  highlight1: 'تصميم معماري حديث وعصري',
  highlight2: 'ممارسات بناء مستدامة وصديقة للبيئة',
  highlight3: 'تقنيات بناء متقدمة ودمج الأنظمة',
  highlight4: 'تنفيذ في الموعد المحدد وضمن الميزانية',
  relatedProjects: 'مشاريع ذات صلة',
  readyToStart: 'هل أنت مستعد لبدء مشروعك؟',
  readyToStartDesc: 'تواصل مع فريقنا اليوم لمناقشة احتياجاتك المعمارية والبنائية',
